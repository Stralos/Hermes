...
const CLIENT_ID = "580587895307-b5g9bectjr3elbuslkq2uks9eq585srr.apps.googleusercontent.com";
const CLIENT_SECRET = "EWDZlaNO97mEKzx5c6QuAB-O";
...
function testCallback(auth: any) {
    console.log("Callback with auth data: ", auth);
}
